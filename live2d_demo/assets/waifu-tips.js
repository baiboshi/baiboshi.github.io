...
// 后端接口
live2d_settings['modelAPI']             = '//live2d.fghrsh.net/api/';   // 自建 API 修改这里 /live2d_demo/live2d_api/
live2d_settings['tipsMessage']          = 'waifu-tips.json';            // 同目录下可省略路径 //live2d.fghrsh.net/api/
...
//看板娘样式设置
live2d_settings['waifuSize']            = '250x230';    // 看板娘大小，例如 '280x250', '600x535'
live2d_settings['waifuTipsSize']        = '200x77';     // 提示框大小，例如 '250x70', '570x150'
live2d_settings['waifuFontSize']        = '3px';       // 提示框字体，例如 '12px', '30px'
live2d_settings['waifuToolFont']        = '20px';       // 工具栏字体，例如 '14px', '36px'
live2d_settings['waifuToolLine']        = '23px';       // 工具栏行高，例如 '20px', '36px'
...
live2d_settings['waifuEdgeSide']        = 'left:30px';     // 看板娘贴边方向，例如 'left:0'(靠左 0px), 'right:30'(靠右 30px)
...
live2d_settings['aboutPageUrl']         = 'https://github.com/baiyunlei/';   // 关于页地址, '{URL 网址}'
