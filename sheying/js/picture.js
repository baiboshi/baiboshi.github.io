$(function() {
        ...
        $(this).hover(function() {
            if ("stop-on" == $(this).attr("id")) {
                if ("" == $(this).children("i").attr("class")) {
                    $(this).children("i").attr("class", "icon-play3")
                } else {
                    $(this).children("i").attr("class", "icon-pause2")
                }
            } else {
                var b = $(this).attr("class");
                $(this).children("i").attr("class", "icon-play3" + (b.substr(b.length - 1, 1)))
            }
        },
        function() {
            if ("stop-on" == $(this).attr("id")) {
                if ("icon-play3" == $(this).children("i").attr("class")) {
    ...
    function() {
        if ("icon-play3" == $(this).children("i").attr("class")) {
            $(this).html('<i class="icon-pause2"></i>已暂停');
            controlPicture.stopAutoPlay()
        } else {
            $(this).html('<i class="icon-play3"></i>自动播放中');
...
function calcPicHover() {
    $(".indexbody-right").mousemove(function() {
        $(this).css("cursor", "url(/sheying/images/next.cur), auto");
        $(this).attr("title", "浏览下一张")
    });
    $(".indexbody-left").mousemove(function() {
        $(this).css("cursor", "url(/sheying/images/pre.cur),auto");
        $(this).attr("title", "浏览上一张")
    })
}
var changeSt = false;
